...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "Notification_archived_idx" ON "Notification"("archived");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "Notification_userId_read_archived_idx" ON "Notification"("userId", "read", "archived");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "admin_logs_userId_idx" ON "admin_logs"("userId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "admin_logs_action_idx" ON "admin_logs"("action");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "admin_logs_entityType_idx" ON "admin_logs"("entityType");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "admin_logs_createdAt_idx" ON "admin_logs"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "admin_logs_entityId_idx" ON "admin_logs"("entityId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ai_insights_restaurantId_createdAt_idx" ON "ai_insights"("restaurantId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ai_insights_type_createdAt_idx" ON "ai_insights"("type", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "ai_insights_pinned_idx" ON "ai_insights"("pinned");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "billing_invoices_number_key" ON "billing_invoices"("number");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "billing_invoices_restaurantId_idx" ON "billing_invoices"("restaurantId");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "billing_invoices_dueDate_idx" ON "billing_invoices"("dueDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "billing_invoices_createdAt_idx" ON "billing_invoices"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "billing_invoices_userId_status_idx" ON "billing_invoices"("userId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "billing_invoices_restaurantId_status_idx" ON "billing_invoices"("restaurantId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cash_flow_records_type_idx" ON "cash_flow_records"("type");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cash_flow_records_category_idx" ON "cash_flow_records"("category");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cash_flow_records_date_idx" ON "cash_flow_records"("date");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cash_flow_records_status_idx" ON "cash_flow_records"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "chart_of_accounts_restaurantId_type_idx" ON "chart_of_accounts"("restaurantId", "type");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "chart_of_accounts_restaurantId_code_key" ON "chart_of_accounts"("restaurantId", "code");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cmv_snapshots_restaurantId_periodEnd_idx" ON "cmv_snapshots"("restaurantId", "periodEnd");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "cmv_snapshots_alertLevel_idx" ON "cmv_snapshots"("alertLevel");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_interactions_customerId_idx" ON "customer_interactions"("customerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_interactions_type_idx" ON "customer_interactions"("type");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_interactions_status_idx" ON "customer_interactions"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_interactions_followUpDate_idx" ON "customer_interactions"("followUpDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_interactions_createdAt_idx" ON "customer_interactions"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_loyalty_accounts_customerId_idx" ON "customer_loyalty_accounts"("customerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_loyalty_accounts_programId_idx" ON "customer_loyalty_accounts"("programId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_loyalty_accounts_tier_idx" ON "customer_loyalty_accounts"("tier");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_loyalty_accounts_currentPoints_idx" ON "customer_loyalty_accounts"("currentPoints");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_loyalty_accounts_lastActivityAt_idx" ON "customer_loyalty_accounts"("lastActivityAt");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "customer_loyalty_accounts_customerId_programId_key" ON "customer_loyalty_accounts"("customerId", "programId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "customer_segments_customerId_key" ON "customer_segments"("customerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customer_segments_segment_idx" ON "customer_segments"("segment");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customers_createdAt_idx" ON "customers"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "customers_restaurantId_idx" ON "customers"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "expense_categories_restaurantId_idx" ON "expense_categories"("restaurantId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "expense_categories_restaurantId_name_key" ON "expense_categories"("restaurantId", "name");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "feature_requests_slug_key" ON "feature_requests"("slug");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_status_idx" ON "feature_requests"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_priority_idx" ON "feature_requests"("priority");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_category_idx" ON "feature_requests"("category");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_isPublic_idx" ON "feature_requests"("isPublic");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_voteCount_idx" ON "feature_requests"("voteCount");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_createdAt_idx" ON "feature_requests"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_requests_status_priority_idx" ON "feature_requests"("status", "priority");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_votes_featureRequestId_idx" ON "feature_votes"("featureRequestId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_votes_userId_idx" ON "feature_votes"("userId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "feature_votes_createdAt_idx" ON "feature_votes"("createdAt");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "financial_forecasts_forecastType_idx" ON "financial_forecasts"("forecastType");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "financial_forecasts_startDate_idx" ON "financial_forecasts"("startDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "financial_metrics_metricType_idx" ON "financial_metrics"("metricType");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "financial_metrics_date_idx" ON "financial_metrics"("date");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "financial_metrics_metricType_period_date_key" ON "financial_metrics"("metricType", "period", "date");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "help_articles_slug_key" ON "help_articles"("slug");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "help_articles_categoryId_idx" ON "help_articles"("categoryId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "help_articles_published_featured_idx" ON "help_articles"("published", "featured");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "help_articles_published_publishedAt_idx" ON "help_articles"("published", "publishedAt");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "help_categories_visible_order_idx" ON "help_categories"("visible", "order");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "income_categories_restaurantId_idx" ON "income_categories"("restaurantId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "income_categories_restaurantId_name_key" ON "income_categories"("restaurantId", "name");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_milestone_redemptions_milestoneId_customerId_idx" ON "loyalty_milestone_redemptions"("milestoneId", "customerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_milestone_redemptions_customerId_idx" ON "loyalty_milestone_redemptions"("customerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_milestones_programId_active_idx" ON "loyalty_milestones"("programId", "active");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "loyalty_milestones_programId_orderCount_key" ON "loyalty_milestones"("programId", "orderCount");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_programs_active_idx" ON "loyalty_programs"("active");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_programs_createdAt_idx" ON "loyalty_programs"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_programs_restaurantId_idx" ON "loyalty_programs"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_rewards_programId_idx" ON "loyalty_rewards"("programId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_rewards_active_idx" ON "loyalty_rewards"("active");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_rewards_pointsCost_idx" ON "loyalty_rewards"("pointsCost");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "loyalty_rewards_createdAt_idx" ON "loyalty_rewards"("createdAt");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_score_idx" ON "marketing_leads"("score");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_createdAt_idx" ON "marketing_leads"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_phoneNumber_idx" ON "marketing_leads"("phoneNumber");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_email_idx" ON "marketing_leads"("email");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_segment_idx" ON "marketing_leads"("segment");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "marketing_leads_restaurantId_idx" ON "marketing_leads"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "menu_engineering_snapshots_restaurantId_periodEnd_idx" ON "menu_engineering_snapshots"("restaurantId", "periodEnd");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "menu_engineering_snapshots_recipeId_idx" ON "menu_engineering_snapshots"("recipeId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "menu_engineering_snapshots_classification_idx" ON "menu_engineering_snapshots"("classification");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaign_recipients_campaignId_idx" ON "message_campaign_recipients"("campaignId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaign_recipients_status_idx" ON "message_campaign_recipients"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaign_recipients_phoneNumber_idx" ON "message_campaign_recipients"("phoneNumber");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaign_recipients_providerMsgId_idx" ON "message_campaign_recipients"("providerMsgId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaigns_restaurantId_idx" ON "message_campaigns"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaigns_status_idx" ON "message_campaigns"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaigns_scheduledAt_idx" ON "message_campaigns"("scheduledAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "message_campaigns_templateId_idx" ON "message_campaigns"("templateId");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "message_templates_restaurantId_name_key" ON "message_templates"("restaurantId", "name");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "messaging_provider_configs_restaurantId_idx" ON "messaging_provider_configs"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "messaging_provider_configs_provider_idx" ON "messaging_provider_configs"("provider");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "messaging_provider_configs_restaurantId_provider_key" ON "messaging_provider_configs"("restaurantId", "provider");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "metric_snapshots_snapshotDate_key" ON "metric_snapshots"("snapshotDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "metric_snapshots_snapshotDate_idx" ON "metric_snapshots"("snapshotDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "packaging_qr_scans_restaurantId_idx" ON "packaging_qr_scans"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "packaging_qr_scans_scannedAt_idx" ON "packaging_qr_scans"("scannedAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "packaging_qr_scans_converted_idx" ON "packaging_qr_scans"("converted");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurant_users_restaurantId_idx" ON "restaurant_users"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurant_users_userId_idx" ON "restaurant_users"("userId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "restaurants_cnpj_key" ON "restaurants"("cnpj");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_status_idx" ON "restaurants"("status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_subscriptionStatus_idx" ON "restaurants"("subscriptionStatus");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_createdAt_idx" ON "restaurants"("createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_subscriptionTier_idx" ON "restaurants"("subscriptionTier");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_ownerId_idx" ON "restaurants"("ownerId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "restaurants_trialEndsAt_idx" ON "restaurants"("trialEndsAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_commissions_period_idx" ON "staff_commissions"("period");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_commissions_status_idx" ON "staff_commissions"("status");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "staff_commissions_staffMemberId_period_key" ON "staff_commissions"("staffMemberId", "period");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "staff_members_userId_key" ON "staff_members"("userId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "staff_members_cpf_key" ON "staff_members"("cpf");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_shifts_shiftDate_idx" ON "staff_shifts"("shiftDate");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_shifts_staffMemberId_idx" ON "staff_shifts"("staffMemberId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "staff_shifts_staffMemberId_shiftDate_key" ON "staff_shifts"("staffMemberId", "shiftDate");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "support_tickets_number_key" ON "support_tickets"("number");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "support_tickets_lastActivityAt_idx" ON "support_tickets"("lastActivityAt");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "voice_agent_configs_restaurantId_key" ON "voice_agent_configs"("restaurantId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "voice_calls_callSid_key" ON "voice_calls"("callSid");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "voice_calls_restaurantId_idx" ON "voice_calls"("restaurantId");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "voice_calls_reservationId_idx" ON "voice_calls"("reservationId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "whatsapp_configs_restaurantId_key" ON "whatsapp_configs"("restaurantId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "whatsapp_conversations_orderSessionId_key" ON "whatsapp_conversations"("orderSessionId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "whatsapp_conversations_restaurantId_idx" ON "whatsapp_conversations"("restaurantId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "whatsapp_conversations_state_idx" ON "whatsapp_conversations"("state");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "whatsapp_conversations_phoneNumber_idx" ON "whatsapp_conversations"("phoneNumber");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "whatsapp_conversations_lastMessageAt_idx" ON "whatsapp_conversations"("lastMessageAt");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "whatsapp_conversations_restaurantId_phoneNumber_key" ON "whatsapp_conversations"("restaurantId", "phoneNumber");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "whatsapp_messages_waMessageId_idx" ON "whatsapp_messages"("waMessageId");
