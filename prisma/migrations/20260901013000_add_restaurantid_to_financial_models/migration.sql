...
-- CashFlowRecord
ALTER TABLE "cash_flow_records" ADD COLUMN IF NOT EXISTS "restaurantId" TEXT;
...
END $$;
CREATE INDEX IF NOT EXISTS "cash_flow_records_restaurantId_idx" ON "cash_flow_records"("restaurantId");

-- FinancialMetric
ALTER TABLE "financial_metrics" ADD COLUMN IF NOT EXISTS "restaurantId" TEXT;
...
EXCEPTION WHEN duplicate_object OR duplicate_table OR invalid_table_definition THEN NULL;
END $$;
CREATE INDEX IF NOT EXISTS "financial_metrics_restaurantId_idx" ON "financial_metrics"("restaurantId");
DROP INDEX IF EXISTS "financial_metrics_metricType_period_date_key";
CREATE UNIQUE INDEX IF NOT EXISTS "financial_metrics_restaurantId_metricType_period_date_key" ON "financial_metrics"("restaurantId", "metricType", "period", "date");

-- FinancialForecast
ALTER TABLE "financial_forecasts" ADD COLUMN IF NOT EXISTS "restaurantId" TEXT;
...
EXCEPTION WHEN duplicate_object OR duplicate_table OR invalid_table_definition THEN NULL;
END $$;
CREATE INDEX IF NOT EXISTS "financial_forecasts_restaurantId_idx" ON "financial_forecasts"("restaurantId");
...
ALTER TABLE "metric_snapshots" ADD COLUMN IF NOT EXISTS "restaurantId" TEXT;
...
EXCEPTION WHEN duplicate_object OR duplicate_table OR invalid_table_definition THEN NULL;
END $$;
CREATE INDEX IF NOT EXISTS "metric_snapshots_restaurantId_idx" ON "metric_snapshots"("restaurantId");
